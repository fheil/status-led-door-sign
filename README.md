...
This project is based on a Wemos/Lolin D1 mini with a WS2812B LED-Strip, a touch LED-Button (to change status) an a 0.96 OLED-Display, to show the status inside my office. 
